...
# 🔥 V215: EL ESPEJO PERFECTO (Muerte al Look-Ahead Bias) 🔥
...
# ==========================================
# 🛡️ 2. GUARDIÁN DE MEMORIA ESTRICTO
# ==========================================
...
# ==========================================
# ⚙️ 3. NÚCLEO C++ DE EVALUACIÓN (Sincronizado con V188)
# ==========================================
@njit(fastmath=True)
    ...
    for i in range(len(h_arr)):
        if en_pos:
            ...
            if s_c[i] or (score < th_sell):
                # FIX V215: Sin Look-Ahead Bias. Salida en el CIERRE ACTUAL.
...
# ==========================================
# 🧠 7. MATRICES NUMPY Y OPTIMIZACIÓN
# ==========================================
