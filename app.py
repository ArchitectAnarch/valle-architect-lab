...
// © Valle_Architect_Lab | AUTO-GENERATED BY OMNI-FORGE V112
...
"""
        ...
        b_cond = pine_map[f"{s_id.split('_')[0].capitalize()}_Buy"] if s_id != "PINK_CLIMAX" else pine_map["Climax_Buy"]
        s_cond = pine_map[f"{s_id.split('_')[0].capitalize()}_Sell"] if s_id != "PINK_CLIMAX" else pine_map["Climax_Sell"]
...
def optimizar_ia_tracker(s_id, cap_ini, com_pct, reinv_q, target_ado, dias_reales, buy_hold_money, epochs=1, cur_fit=-float('inf')):
    ...
    # 🚀 MEMORY PRE-ALLOCATION (X1000 SPEED)
